...
<body>
  <div class="d-flex vh-100">
    <!-- Kiri -->
    <div class="left-side d-flex flex-column justify-content-start p-5"
      style="flex: 1; background-color: #d8c8f8; color: #2d1460; position: relative;">
      <h1 class="logo fw-bold fs-3 mb-4">StudySpace</h1>
      <h2 class="fw-bold fs-4 mb-2">Selamat Datang Kembali!</h2>
      <p class="text-muted small mb-4" style="max-width: 300px;">Satu langkah ke depan buat masa depan cerah. Yuk login,
        dan jadi versi terbaik dari dirimu</p>
      <p class="small mb-2">Belum punya akun?</p>
      <a href="<?= base_url('daftar') ?>" class="btn-outline-custom">Daftar</a>

      <div class="mt-auto align-self-end">
        <img src="<?= base_url('asset/ilustrasi_login.png') ?>" alt="Ilustrasi" class="img-fluid" />
      </div>
    </div>
