      ...
      <div class="form-box bg-white p-5 rounded shadow" style="max-width: 600px; width: 100%;">
        ...
        <form action="<?= base_url('login/process') ?>" method="post">
          <div class="input-wrapper d-flex align-items-center bg-light p-2 rounded mb-4">
            ...
            <input type="text" name="email" class="form-control border-0 bg-transparent" placeholder="E-mail" required />
          </div>

          <div class="input-wrapper d-flex align-items-center bg-light p-2 rounded mb-4">
            <i class='bx bx-lock-alt me-2' style="color: #3f2d7c;"></i>
            <input type="password" name="password" class="form-control border-0 bg-transparent" placeholder="Password" required />
          </div>
