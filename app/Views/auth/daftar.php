...
<body>
  <div class="d-flex vh-100">
    ...
    <div class="left-side d-flex flex-column justify-content-start p-5"
      ...
      <p class="text-muted small mb-4" style="max-width: 300px;">Gabung dan mulai petualangan belajarmu bareng
        StudySpace!</p>
          ...
          <div class="mb-3">
            <div class="input-wrapper d-flex align-items-center bg-light p-2 rounded">
              ...
              <select class="form-select border-0 bg-transparent shadow-none"
                style="font-size: 13px; font-weight: 500; color: #3f2d7c;" name="gender" required>
